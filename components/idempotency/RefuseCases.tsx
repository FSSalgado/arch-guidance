...
import { REFUSE_CASES } from "@/lib/idempotency/refuse";
...
export function RefuseCases() {
  ...
  return (
    <Section
      ...
      title="Onde você recusa o segundo pedido — e a segunda verdade"
      lead="Quem só recita “idempotente” e “outbox” ainda não terminou a página. Clique o caso: o juízo é recusar PlaceOrder sem chave e recusar publish fora do commit."
    >
