...
import { REFUSE_CASES } from "@/lib/coupling/refuse";
...
export function RefuseCases() {
  ...
  return (
    <Section
      id="recusar"
      kicker="FIG. 05 — O critério de aceite"
      title="Onde você recusa o movimento da moda"
      lead="Quem só recita “baixo acoplamento, alta coesão” ainda não terminou a página. Clique o caso e veja se a jogada é recusar a fatiadura — ou tratar o cheiro de verdade."
    >
