...
import { REFUSE_CASES } from "@/lib/adr/refuse";
...
export function RefuseCases() {
  ...
  return (
    <Section
      ...
      title="Onde você recusa o papel — e o silêncio"
      lead="Quem só recita “contexto, decisão, consequências” ainda não terminou a página. Clique o caso: o juízo é recusar ADR no local reversível — e recusar o Slack como único rastro da escolha cara."
    >
