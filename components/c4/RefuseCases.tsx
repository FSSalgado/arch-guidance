...
import { REFUSE_CASES } from "@/lib/c4/refuse";
...
export function RefuseCases() {
  ...
  return (
    <Section
      ...
      title="Onde você recusa o slide único"
      lead="Quem só recita contexto, container, componente ainda não terminou a página. Clique o caso: o juízo é recusar empresa, deploy e classe no mesmo plano — e recusar C4 no lugar de ADR."
    >
