...
import { REFUSE_CASES } from "@/lib/resilience/refuse";
...
export function RefuseCases() {
  ...
  return (
    <Section
      ...
      title="Onde você recusa esperar o cadáver"
      lead="Quem só recita timeout, retry e breaker ainda não terminou a página. Clique o caso: o juízo é recusar retry no charge sem chave — e recusar a loja herdar o hang do PSP."
    >
